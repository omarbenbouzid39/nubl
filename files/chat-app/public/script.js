...
function verifiedBadge(verified) {
  if (!verified) return '';
  return `<img src="/verified.png" alt="موثق" class="verified-badge-img" title="حساب موثق ✔" />`;
}
        ...
        <div style="display:flex;flex-direction:column;align-items:center;gap:14px">
          ...
          <div>
            <div style="font-size:18px;font-weight:700;color:var(--text-primary);display:flex;align-items:center;justify-content:center;gap:6px">
              ${escapeHtml(username)}
              ${data.verified ? `<span style="display:inline-flex;align-items:center;gap:5px;background:#3b82f620;border:1px solid #3b82f640;border-radius:999px;padding:3px 10px;font-size:12px;color:#3b82f6;font-weight:700"><img src="/verified.png" alt="موثق" style="width:15px;height:15px;border-radius:50%;object-fit:cover" />موثق</span>` : ''}
            </div>
