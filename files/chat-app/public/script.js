...
function verifiedBadge(verified) {
  if (!verified) return '';
  return `<span class="verified-badge" title="موثق ✔">
    <svg width="13" height="13" viewBox="0 0 24 24" fill="#3b82f6"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" stroke="#fff" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/><circle cx="12" cy="12" r="12" fill="#3b82f6" opacity="0.15"/><path d="M9 12l2 2 4-4" stroke="#3b82f6" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>
  </span>`;
}
        ...
        <div style="display:flex;flex-direction:column;align-items:center;gap:14px">
          ...
          <div>
            <div style="font-size:18px;font-weight:700;color:var(--text-primary);display:flex;align-items:center;justify-content:center;gap:6px">
              ${escapeHtml(username)}
              ${data.verified ? `<span style="display:inline-flex;align-items:center;background:#3b82f620;border:1px solid #3b82f640;border-radius:999px;padding:2px 8px;font-size:12px;color:#3b82f6;gap:4px">✔ موثق</span>` : ''}
            </div>
